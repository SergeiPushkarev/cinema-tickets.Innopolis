 ...
 * ОТВЕТ: преобразовывать значения к одному виду через String(), Number(), Boolean(), BigInt()
 */
 ...
 const birthAge = year - age;
 console.log (`Я родился в ${birthAge} году.`)
...
//  ОТВЕТ: Лучше всегда выводить строгое неравенство и приводить значения к одному типу, добавлять проверки.
 
 // Попробуйте привести к boolean типу значения с помощью конструкции
 // Boolean()
 // (144) (0) (true) (false) ({}) ({ name: 'Вася' }) ([]) ([1, 2, 3])
 // ОТВЕТ: Все true, кроме 0 и false.По спецификации все объекты являются true даже если они пустые