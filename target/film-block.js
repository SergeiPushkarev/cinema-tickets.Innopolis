      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          data.films.forEach( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(film, i) {
              var _renderBlockFilms, _renderBlockFilms2, filmConteiner, description;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _renderBlockFilms = renderBlockFilms(film.posterUrlPreview, film.nameRu, film.filmId), _renderBlockFilms2 = _slicedToArray(_renderBlockFilms, 2), filmConteiner = _renderBlockFilms2[0], description = _renderBlockFilms2[1];
