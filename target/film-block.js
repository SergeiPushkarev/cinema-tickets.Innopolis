...
function renderBlockFilms(posterUrl, nameRu) {
  ...
  var itemDescr = document.createElement('a');
  ...
  imgBg.width = '283px';
  itemBg.append(imgBg);
  var descrHead = document.createElement('div');
  var descrTxt = document.createElement('div');
...
var getBlockFilmsData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var answer, data, request, filmsLayout, filmsLayouts;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            data.films.forEach( /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(film) {
                var _renderBlockFilms, _renderBlockFilms2, filmConteiner, description;
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _renderBlockFilms = renderBlockFilms(film.posterUrlPreview, film.nameRu), _renderBlockFilms2 = _slicedToArray(_renderBlockFilms, 2), filmConteiner = _renderBlockFilms2[0], description = _renderBlockFilms2[1];
                        filmsLayout.set(film.filmId, filmConteiner);
                        request.push(new Promise( /*#__PURE__*/function () {
                          var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
                            var _answer, dataFilmId;
                              ...
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  case 0:
                                    _context.prev = 0;
                                    _context.next = 3;
                                    return getFilmById(film.filmId);
                                  case 3:
                                    _answer = _context.sent;
                                    _context.next = 6;
                                    return _answer.json();
                                  case 6:
                                    dataFilmId = _context.sent;
          ...
          case 12:
            filmsLayouts = _toConsumableArray(filmsLayout.values()).slice(0, 9);
            movieConteiner.append.apply(movieConteiner, _toConsumableArray(filmsLayouts));
            _context3.next = 19;
            break;
          case 16:
            _context3.prev = 16;
...
// getBlockFilmsData();
//# sourceMappingURL=film-block.js.map